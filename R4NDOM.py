...
╚╝╚═╝╝╚╝╩ ╩ ╩ ╚═╝═╩╝
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : JUNAYED HASNAT MRIDUL            │
    │ [✓] GITHUB   : J4NAYED–BRUH              │
    │ [✓] WHATSAPP : +8801608107921        │
    │ [✓] POWER BY : \033[1;32m BhaiYa Gang\033[1;37m           │
    └───────────────────────────────────────┘""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[JUNAYED x1] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()